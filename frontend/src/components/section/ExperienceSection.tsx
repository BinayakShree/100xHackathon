...
const experiences = [
  ...
  {
    id: "05",
    title: "Mountain Village Stay",
    description: "Experience local life by staying with mountain families.",
    image: "/walk.png",
  },
]
    ...
    <section className="">
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="flex items-center justify-between mb-12">
          <h2 className="text-4xl md:text-5xl lg:text-[64px] font-playfair-display">Experiences We Offer</h2>
        ...
        >
          {experiences.map((experience) => (
            <div
              key={experience.id}
              className="experience-card shrink-0 w-[85vw] sm:w-[calc(50%-12px)] lg:w-[calc(33.333%-16px)] xl:w-[calc(25%-18px)] overflow-hidden border-0 shadow-none group cursor-pointer snap-start"
            >
              {/* Image Section */}
              <div className="relative aspect-square overflow-hidden rounded-[20px]">
                ...
                <div className="absolute top-6 left-6">
                  <span className="text-[32px] font-poppins text-white">{experience.id}</span>
                </div>
              </div>
